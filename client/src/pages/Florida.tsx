// Florida — Captain's Charter Weather
// Overview of all Florida regions with Go/No-Go status cards
    ...
    <div style={{ paddingTop: "3.5rem" }}>
      ...
      <div className="py-12" style={{ background: "linear-gradient(180deg, #0D1520 0%, #0A0E14 100%)", borderBottom: "1px solid #1A2D42" }}>
        <div className="container">
          ...
          <h1 className="font-tactical text-white mb-3" style={{ fontSize: "2.5rem", fontWeight: 800, letterSpacing: "0.05em" }}>FLORIDA</h1>
